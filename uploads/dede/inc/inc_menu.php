...
<m:top item='10_' name='系统设置' display='none' rank='sys_User,sys_Group,sys_Edit,sys_Log,sys_Data'>
  ...
  <m:item name='文档日志管理' link='archives_log_list.php' rank='archives_Log' target='main' />
...
<m:top item='5_' name='自动任务' notshowall='1'  display='block' rank='sys_MakeHtml'>
  <m:item name='一键生成网站' link='makehtml_all.php' rank='sys_MakeHtml' target='main' />
  <m:item name='更新系统缓存' link='sys_cache_up.php' rank='sys_ArcBatch' target='main' />
  {$remoteMenu}
</m:top>
...
<m:top item='1_10_7_' name='系统帮助' display='none'>
  <m:item name='帮助中心' link='http://help.dedecms.com/' rank='' target='_blank' />
  <m:item name='常见问题' link='http://help.dedecms.com/changjianwenti/' rank='' target='_blank' />
  <m:item name='使用手册' link='http://help.dedecms.com/chujie/' rank='' target='_blank' />
  <m:item name='模板手册' link='http://help.dedecms.com/mubanshouce/' rank='' target='_blank' />
</m:top>
